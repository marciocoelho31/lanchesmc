...
namespace LanchesMC.Extensao
{
    public static class MetodosExtensao
    {
        public static IHost CreateAdminRole(this IHost host)    // (this Ixxxx yyyy) - essa é a assinatura de um método de extensao
        {
